 ...
 * It includes details such as the reason for the report, any additional custom reason provided by the user,
 * and the associated post's title and content. It also provides a link to view the full report.
 */
